    ...
    <header className="sticky top-0 z-50 bg-[#FAF3E7]/90 backdrop-blur-md border-b border-[#F0E4D3] shadow-[0_4px_20px_rgba(180,110,40,0.08)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          {/* Navigation Links with clear active states */}
          <nav className="flex items-center space-x-2 sm:space-x-3">
            ...
            >
              <FileSpreadsheet className={`w-4 h-4 ${isDashboardActive ? 'text-white' : 'text-[#EA580C]'}`} />
              <span>Dashboard</span>
            </Link>
            ...
            >
              <PlusCircle className={`w-4 h-4 ${isCreateJobActive ? 'text-white' : 'text-[#EA580C]'}`} />
