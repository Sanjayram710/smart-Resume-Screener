...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_screenings_overall_score'), 'screenings', ['overall_score'], unique=False)
    op.create_index(op.f('ix_screenings_recommendation'), 'screenings', ['recommendation'], unique=False)
    ...
    op.create_index(op.f('ix_matched_skills_screening_id'), 'matched_skills', ['screening_id'], unique=False)
    ...
    op.create_index(op.f('ix_missing_skills_screening_id'), 'missing_skills', ['screening_id'], unique=False)
