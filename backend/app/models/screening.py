...
class Screening(Base):
    ...
    matched_skills = relationship(
        "MatchedSkill", back_populates="screening", cascade="all, delete-orphan"
    )
    missing_skills = relationship(
        "MissingSkill", back_populates="screening", cascade="all, delete-orphan"
    )
